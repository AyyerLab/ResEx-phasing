...
cfile='4et8_config-6.ini'
fsc_file='data/recon_liq_0.8-100-outer150-bgfit-randstartDM/FSC.txt'
fsc_value='0.400'
...
do  
	...
	dirname="data/recon_liq_0.8-100-outer150-bgfit-randstartDM/$i/"
	mkdir $dirname
	...
	#calculate FSC
	./utils/calc_fsc ./data/4et8_full_2mFo-DFc-srecon.raw ./data/recon_temp6/4et8_full-pd.raw 301 2
	...
	cp data/recon_temp6/4et8_full-log.dat $cfile data/recon_temp6/4et8_full-last.raw fsc-0-0.dat data/recon_temp6/4et8_full-prtf.dat $dirname
done
