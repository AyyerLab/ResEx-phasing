...
Then the Fourier transform magnitudes are rescaled as described above and then inverse Fourier transformed back:
...
A procedure similar to solvent flattening in crystallography is used to update the support mask every iteraton.
